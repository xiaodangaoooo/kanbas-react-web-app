...
export default function PeopleTable() {
  ...
  const [selectedUser, setSelectedUser] = useState<string | null>(uid || null);
    ...
    <div id="wd-people-table" className="position-relative">
      ...
      <table className="table table-striped">
        ...
        <tbody>
          {users.map((user: any) => (
            <tr key={user._id}>
              <td className="wd-full-name text-nowrap text-danger" onClick={() => handleUserClick(user._id)} style={{cursor: 'pointer'}}>
